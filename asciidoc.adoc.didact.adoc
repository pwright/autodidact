...
+++<pre>$ <a href=didact://?commandId=vscode.didact.sendNamedTerminalAString&text=bash$$autodidact%20asciidoc.adoc style="text-decoration:none">autodidact asciidoc.adoc</a></pre>+++
